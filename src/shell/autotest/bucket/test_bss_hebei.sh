...
testCreateSwitchBoard(){
    ...
    paramter=`cat template/hb_clientinfo.xml|tr "\n" " "`
    ...
    if [ $status -gt 0 ]
    then
        fail "[新装总机]失败,无法生成clientinfo企业信息" error
        return $status
    fi
    paramter=`cat template/hb_NumberInfo.xml|tr "\n" " "`
    paramter=${paramter/EMIC_NEED_REPLACE_EPCODE/$epCode}
...
testCreateDirectNumber(){
    ...
    paramter=`cat template/hb_NumberInfo.xml|tr "\n" " "`
    paramter=${paramter/EMIC_NEED_REPLACE_EPCODE/$epCode}
    paramter=${paramter/EMIC_NEED_REPLACE_OPERATE/"createdirectnumber"}
    paramter=${paramter/EMIC_NEED_REPLACE_NUMBER/$number}
    paramter=${paramter/EMIC_NEED_REPLACE_PLANCODE/}
    paramter=${paramter/EMIC_NEED_REPLACE_USERNUMBER/}
    paramter=${paramter/EMIC_NEED_REPLACE_SWITCHNUMBER/$switch_number}  
...
testCreateMeetBridgeNumber(){
    ...
    paramter=`cat template/hb_NumberInfo.xml|tr "\n" " "`
    paramter=${paramter/EMIC_NEED_REPLACE_EPCODE/$epCode}
    paramter=${paramter/EMIC_NEED_REPLACE_OPERATE/"createmeetbridgenumber"}
    paramter=${paramter/EMIC_NEED_REPLACE_NUMBER/$number}
    paramter=${paramter/EMIC_NEED_REPLACE_PLANCODE/39992078}
    paramter=${paramter/EMIC_NEED_REPLACE_USERNUMBER/}
    paramter=${paramter/EMIC_NEED_REPLACE_SWITCHNUMBER/$switch_number}  
...
testModifyMaxMember(){
    ...
    paramter=`cat template/hb_NumberInfo.xml|tr "\n" " "`
    paramter=${paramter/EMIC_NEED_REPLACE_EPCODE/$epCode}
    paramter=${paramter/EMIC_NEED_REPLACE_OPERATE/modifymaxmember}
    paramter=${paramter/EMIC_NEED_REPLACE_NUMBER/$number}
    paramter=${paramter/EMIC_NEED_REPLACE_PLANCODE/39992075}
    paramter=${paramter/EMIC_NEED_REPLACE_USERNUMBER/200}
    paramter=${paramter/EMIC_NEED_REPLACE_SWITCHNUMBER/$switch_number}  
...
testModifyNumberStatus(){
    print_log "开始测试修改号码状态操作"
    number="$areacode$meetingNumber"
    numberStatus="1"

    paramter=`cat template/hb_NumberSts.xml|tr "\n" " "`
    #paramter=${paramter/EMIC_NEED_REPLACE_OPERATE/modifyNumberStatus}
    paramter=${paramter/EMIC_NEED_REPLACE_NUMBER/$number}
    paramter=${paramter/EMIC_NEED_REPLACE_STATUS/$numberStatus}  
...
testDeleteNumber(){
    ...
    paramter=`cat template/hb_NumberInfo.xml|tr "\n" " "`
    paramter=${paramter/EMIC_NEED_REPLACE_EPCODE/}
    paramter=${paramter/EMIC_NEED_REPLACE_OPERATE/deletenumber}
    paramter=${paramter/EMIC_NEED_REPLACE_NUMBER/$number}
    paramter=${paramter/EMIC_NEED_REPLACE_PLANCODE/}
    paramter=${paramter/EMIC_NEED_REPLACE_USERNUMBER/}
    paramter=${paramter/EMIC_NEED_REPLACE_SWITCHNUMBER/}  
